      ...
      >
        ...
        >
          <div
            ...
            className="flex h-full w-full flex-col [background:var(--sidebar-gradient)] group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
